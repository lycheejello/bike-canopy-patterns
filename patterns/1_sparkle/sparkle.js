...
//
// A dim base glow under sharp twinkles. The original ignited twinkles on treble
// transients; with the Sensor Expansion Board that mechanism is back, and the
// detected kick is mixed in alongside it so bursts land on the beat as well as
// on the hats.
//
...
var FALL_BASS = 150, FALL_MID = 250, FALL_TREBLE = 80,  FALL_LEVEL = 200, FALL_BEAT = 140
...
export function beforeRender(delta) {
  ...
  // Ignite on TREBLE, which is what upstream does and what the pattern is for:
  // hi-hats and cymbals scatter the twinkles. Squared for contrast, and gated so
  // quiet passages stay quiet instead of drizzling at a flat rate.
  var ignite = eTreble > 0.08 ? eTreble * eTreble * 0.6 * twinkle : 0
